...
import type { RenderContextWebGPU } from "../webgpu";
...
export interface RenderModule {
    ...
    withContext(context: RenderContextWebGPU): RenderModuleContext | Promise<RenderModuleContext>;
}
...
export interface RenderModuleContext {
     ...
     */
    update(encoder: GPUCommandEncoder, state: DerivedRenderState): void;
     ...
     * @param state The current frame render state.
     */
    render(encoder: GPUCommandEncoder, state: DerivedRenderState): void;
