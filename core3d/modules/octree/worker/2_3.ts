...
export function readSchema(r: BufferReader) {
    ...
    const schema = {
        ...
        vertex: {
            length: sizes[7],
            position16: !flags[0] ? undefined : {
                length: sizes[7],
                x: r.i16(sizes[7]),
                y: r.i16(sizes[7]),
                z: r.i16(sizes[7]),
            } as Int16_3,
            position32: !flags[1] ? undefined : {
                length: sizes[7],
                x: r.i32(sizes[7]),
                y: r.i32(sizes[7]),
                z: r.i32(sizes[7]),
            } as Int32_3,
            normal: !flags[2] ? undefined : {
                length: sizes[7],
                x: r.i8(sizes[7]),
                y: r.i8(sizes[7]),
                z: r.i8(sizes[7]),
            } as Int8_3,
            color: !flags[3] ? undefined : {
                length: sizes[7],
                red: r.u8(sizes[7]),
                green: r.u8(sizes[7]),
                blue: r.u8(sizes[7]),
            ...
            texCoord: !flags[4] ? undefined : {
                length: sizes[7],
                x: r.f16(sizes[7]),
                y: r.f16(sizes[7]),
            } as Half2,
            projectedPos16: !flags[5] ? undefined : {
                length: sizes[7],
                x: r.i16(sizes[7]),
                y: r.i16(sizes[7]),
                z: r.i16(sizes[7]),
            } as Int16_3,
            projectedPos32: !flags[6] ? undefined : {
                length: sizes[7],
                x: r.i32(sizes[7]),
                y: r.i32(sizes[7]),
                z: r.i32(sizes[7]),
        ...
        triangle: {
            length: sizes[8],
            topologyFlags: !flags[15] ? undefined : r.u8(sizes[8]),
        } as Triangle,
        vertexIndex: !flags[16] ? undefined : r.u16(sizes[9]),
